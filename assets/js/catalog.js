...
class Catalog {
    ...
    getTestProducts() {
        ...
        return [
            { id: 1, name: 'Букет из 25 красных роз', slug: 'bouquet-25-red-roses', price: 5000, category_slug: 'bukety', flowers: ['roza'], image: 'assets/img/products/product-1.png', badge: 'Хит', is_popular: true, is_new: false },
            { id: 2, name: 'Букет тюльпанов', slug: 'bouquet-tulips', price: 3600, category_slug: 'bukety', flowers: ['tyul-pan'], image: 'assets/img/products/product-2.png', badge: 'Новинка', is_popular: false, is_new: true },
            { id: 3, name: 'Свадебный букет', slug: 'wedding-bouquet', price: 7000, category_slug: 'wedding', flowers: ['roza', 'eustoma'], image: 'assets/img/products/product-3.png', badge: null, is_popular: true, is_new: false },
            { id: 4, name: 'Композиция в корзине', slug: 'composition-basket', price: 4400, category_slug: 'korziny', flowers: ['roza', 'gortenziya'], image: 'assets/img/products/product-4.png', badge: null, is_popular: false, is_new: false },
            { id: 5, name: 'Букет из пионов', slug: 'bouquet-peonies', price: 6400, category_slug: 'bukety', flowers: ['pion'], image: 'assets/img/products/product-5.png', badge: 'Хит', is_popular: true, is_new: false },
            { id: 6, name: 'Эксклюзивный букет', slug: 'exclusive-bouquet', price: 9000, category_slug: 'exclusive', flowers: ['roza', 'pion', 'ranunkulyus'], image: 'assets/img/products/product-6.png', badge: 'Exclusive', is_popular: true, is_new: true },
            { id: 7, name: 'Flower Box Нежность', slug: 'flower-box-tenderness', price: 5600, category_slug: 'flower-box', flowers: ['roza'], image: 'assets/img/products/product-1.png', badge: null, is_popular: false, is_new: true },
            { id: 8, name: 'Корзина с гортензиями', slug: 'basket-hydrangeas', price: 7600, category_slug: 'korziny', flowers: ['gortenziya'], image: 'assets/img/products/product-2.png', badge: null, is_popular: true, is_new: false },
            { id: 9, name: 'Букет с лилиями', slug: 'bouquet-lilies', price: 5400, category_slug: 'bukety', flowers: ['liliya'], image: 'assets/img/products/product-3.png', badge: null, is_popular: false, is_new: false },
            { id: 10, name: 'Шляпная коробка Premium', slug: 'hat-box-premium', price: 8400, category_slug: 'shlap-korob', flowers: ['roza', 'pion'], image: 'assets/img/products/product-4.png', badge: 'Premium', is_popular: true, is_new: false },
            { id: 11, name: 'Букет из эустомы', slug: 'bouquet-eustoma', price: 4600, category_slug: 'bukety', flowers: ['eustoma'], image: 'assets/img/products/product-5.png', badge: null, is_popular: false, is_new: true },
            { id: 12, name: 'Композиция в вазе', slug: 'composition-vase', price: 6200, category_slug: 'kompozicii', flowers: ['roza', 'gortenziya', 'eustoma'], image: 'assets/img/products/product-6.png', badge: null, is_popular: false, is_new: false },
        ];
    }
        ...
        return `
            <div class="product-card" data-aos="fade-up" data-id="${product.id}">
                <div class="product-card__image">
                    ...
                    <!-- Center Quick View Button (appears on hover) -->
                    <button class="quick-view-btn-center" data-action="quickview" data-id="${product.id}">
                        Быстрый просмотр
                    </button>
                    
                    <!-- Product ID & Status overlay -->
                    <div class="product-id-wrapper">
                        <span class="status-dot ${product.id % 2 === 0 ? 'yellow' : ''}"></span> <!-- Mock status logic -->
                        <span class="product-id-overlay">№ ${product.id + 2000} M</span>
                    </div>
                </div>
                <div class="product-card__content">
                    ...
                    <div class="product-card__bottom-row">
                        <div class="product-card__price">${this.formatPrice(product.price)} руб.</div>
                    </div>
                </div>
                <!-- Favorites button absolute top-right (custom style) -->
                 <button class="product-card__favorite-btn ${isFavorite ? 'active' : ''}" 
